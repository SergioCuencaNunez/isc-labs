...
median_times <- aggregate(benchmark_results$time, by = list(benchmark_results$expr), FUN = median)
...
median_times_large <- aggregate(benchmark_results_long$time, by = list(benchmark_results_long$expr), FUN = median)
...
monte_carlo_median_times <- aggregate(monte_carlo_benchmark$time, by = list(monte_carlo_benchmark$expr), FUN = median)
...
fib_median_times <- aggregate(fib_benchmark$time, by = list(fib_benchmark$expr), FUN = median)
...
write_median_times <- aggregate(write_benchmark$time, by = list(write_benchmark$expr), FUN = median)
