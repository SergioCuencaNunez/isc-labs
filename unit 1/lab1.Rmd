...
In order to perform the exercise in this practice you should install and load the `microbenchmark` and `profvis` packages. Also install `devtools` and the `proftools` package from CRAN.
