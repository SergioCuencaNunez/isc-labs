...
The function `lapply` took longer than the code in Q5b, which only needed 0.02s. This function works as a `for` loop, in comparison to the code in Q5b, which standardizes the vector using a vectorized approach.
